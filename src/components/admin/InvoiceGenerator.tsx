                  ...
                  <TableRow key={invoice.id}>
                    ...
                    <TableCell>
                      <div className="flex justify-end gap-1">
                        <Button variant="ghost" size="sm" onClick={() => viewInvoice(invoice)} title="View">
                          <Eye className="h-4 w-4" />
                        </Button>
                        <Button variant="ghost" size="sm" onClick={() => copyInvoiceLink(invoice)} title="Copy Link">
                          <Copy className="h-4 w-4" />
                        </Button>
                        <Button variant="ghost" size="sm" onClick={() => shareViaWhatsApp(invoice)} title="Share via WhatsApp" className="text-green-600 hover:text-green-700">
                        ...
                        {(invoice.status === "sent" || invoice.status === "viewed") && (
                          <Button variant="ghost" size="sm" onClick={() => updateInvoiceStatus(invoice.id, "paid")} title="Mark as Paid">
                            <CheckCircle className="h-4 w-4 text-green-600" />
                          </Button>
                        )}
                        <Button variant="ghost" size="sm" onClick={() => deleteInvoice(invoice.id)} title="Delete">
      ...
      <Dialog open={isViewOpen} onOpenChange={setIsViewOpen}>
        <DialogContent className="max-w-2xl">
          ...
          <DialogFooter className="print:hidden gap-2 flex-wrap">
            ...
            <Button variant="outline" onClick={() => selectedInvoice && copyInvoiceLink(selectedInvoice)}>
              <Copy className="h-4 w-4 mr-2" />
              Copy Link
            </Button>
            <Button variant="outline" className="text-green-600 border-green-600 hover:bg-green-50" onClick={() => selectedInvoice && shareViaWhatsApp(selectedInvoice)}>
